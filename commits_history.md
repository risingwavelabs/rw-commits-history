...
- `3fb3b9c2b756a0f9ee1f8f6979a797ce32e137ad` [chore(deps): Bump quick-xml from 0.38.3 to 0.39.0 (#24432)](https://github.com/risingwavelabs/risingwave/pull/24432)
- `6c57feee455a16ecfab9b15af234db2a15785a6f` [chore(deps): Bump rustls-pki-types from 1.13.0 to 1.14.0 (#24510)](https://github.com/risingwavelabs/risingwave/pull/24510)
- `b547a843c3177f1ff7ac96a8cd99cb252b70e0db` [chore(deps): Bump http from 1.3.1 to 1.4.0 (#23828)](https://github.com/risingwavelabs/risingwave/pull/23828)
- `d77d8ba73fca2f137d164384fc4c3c4cdb482ee4` [chore(deps): Bump fs-err from 3.1.0 to 3.2.2 (#24257)](https://github.com/risingwavelabs/risingwave/pull/24257)
- `9a242aff5eb74867468bdd4f24638f57500e166b` [chore(deps): Bump arc-swap from 1.7.1 to 1.8.0 (#24251)](https://github.com/risingwavelabs/risingwave/pull/24251)
- `776764aa256bba27241c1f1945a0af80a303001c` [chore(deps): Bump crepe from 0.1.8 to 0.2.0 (#24132)](https://github.com/risingwavelabs/risingwave/pull/24132)
- `5c4a471dc9025eca9df5e9369ce236e8673816ce` [chore(deps): Bump fancy-regex from 0.16.1 to 0.17.0 (#24126)](https://github.com/risingwavelabs/risingwave/pull/24126)
- `7f2e70b1f44069a11a13e2715b6c3484333d916c` [feat(storage): enable watermark read for all WatermarkSerdeType (#24563)](https://github.com/risingwavelabs/risingwave/pull/24563)
- `74d0bc1aa825d4eec3e5b9771758c32caa04db3d` [chore(deps): Bump duration-str from 0.17.0 to 0.18.0 (#23968)](https://github.com/risingwavelabs/risingwave/pull/23968)
- `59a2755ad069aad334f40d7b2d914507584120da` [chore(deps): Bump bytes from 1.10.1 to 1.11.0 (#23770)](https://github.com/risingwavelabs/risingwave/pull/23770)
- `dc4525929594e0607d904affa43d311b28cc1c64` [test(cdc): wait for and verify data before schema change (#24562)](https://github.com/risingwavelabs/risingwave/pull/24562)
- `f64776ad65a81ef21cd8eacc1736944165494342` [chore(deps): Bump notify from 8.0.0 to 8.2.0 (#24129)](https://github.com/risingwavelabs/risingwave/pull/24129)
- `fe3539d4b522ae7df539b4b3a5792da32251d778` [feat(snapshot-backfill): support alter rate limit for snapshot backfill (#24302)](https://github.com/risingwavelabs/risingwave/pull/24302)
- `758bc7196ecde4c2769d3f73c1b149c9be6239ca` [chore(deps): Bump rust-embed from 8.8.0 to 8.11.0 (#24465)](https://github.com/risingwavelabs/risingwave/pull/24465)
- `b10151b74fc951d31fa57f5abbf46702cd9219ef` [refactor(test): add tests for watermark based state cleaning (#24549)](https://github.com/risingwavelabs/risingwave/pull/24549)
- `2b4bdfcc5acc6267a40782cc8fec6239fef22883` [chore(deps): Bump tempfile from 3.19.1 to 3.20.0 (#21834)](https://github.com/risingwavelabs/risingwave/pull/21834)
- `0d02ed6db21d119f8d27dbfadecc9c56abdaee1c` [feat(ci): generate grafana artifacts for cloud (#24545)](https://github.com/risingwavelabs/risingwave/pull/24545)
...
## nightly-20260110
[compare changes with previous nightly build](https://github.com/risingwavelabs/risingwave/compare/8641a0c6a38ed875f68b382d2e79c0e2ed5a9d5a...ddfb5ef01b2f9a28b7ab182e4516df1e5932bee2)
...
- `092216f47214c6c433243a6d2cb391ddf7493a8b` [fix(test):  do not rely on records before sink formatting error can always be written and acked (#23765)](https://github.com/risingwavelabs/risingwave/pull/23765)
- `d69c44da50f8b7952726f07bafe66b001acd0dec` [refactor(meta): maintain per job create mview progress separately (#23744)](https://github.com/risingwavelabs/risingwave/pull/23744)
- `800bb6f3341ddce560050caeba52506a0279a19c` [fix(cdc): handle numeric identifiers in connector properties when alter source (#23769)](https://github.com/risingwavelabs/risingwave/pull/23769)
...
## nightly-20251030
[compare changes with previous nightly build](https://github.com/risingwavelabs/risingwave/compare/7a827c1c4cb05fb8d6c81c97fdbf0b2e77feb191...1d4537b03bfd18fd8e6b4a3283ff567acc286c3d)
...
## nightly-20250919
[compare changes with previous nightly build](https://github.com/risingwavelabs/risingwave/compare/b7c6fe53bbcacbd21ee7ce52a0cb91e10ea53521...dce92415d8636d7e9188b2cf58ce99943c26c447)
...
- `cc6431bc985d8d7d909f1edd7f5ea573de85f105` [feat: Add source_splits model, persist discovered source splits (#23194)](https://github.com/risingwavelabs/risingwave/pull/23194)
- `04489af31a4fef5b7d85f1e35dc5caaa3372e3dd` [test(source): add an e2e test for empty protobuf message (#23121)](https://github.com/risingwavelabs/risingwave/pull/23121)
- `6b53065f786228fda7010559a1393a82f9d5c728` [feat(optimizer): support UnifyFirstLastValueRule (#23146)](https://github.com/risingwavelabs/risingwave/pull/23146)
- `0ae2374ba359cf463f052073ee743bdbb80373e6` [feat(sink): support https clickhouse sink (#23192)](https://github.com/risingwavelabs/risingwave/pull/23192)
- `461501ea97f24f4992185113665900dbba562fa7` [feat(iceberg): support alter iceberg table connector with (#22040)](https://github.com/risingwavelabs/risingwave/pull/22040)
...
- `f67d950ec5fa10e1e894c1c501925b49fb295525` [fix(iceberg): remove iceberg parquet lib (#21436)](https://github.com/risingwavelabs/risingwave/pull/21436)
...
- `2e1ab810a1677a4050ce84d7491aa3777630d772` [feat: enforce some props to be secret on RisingWave Cloud (#21248)](https://github.com/risingwavelabs/risingwave/pull/21248)
...
- `478c7ad228112b58895d0b3810007ff338c5945a` [chore(deps): Bump rust-embed from 8.6.0 to 8.7.0 (#21347)](https://github.com/risingwavelabs/risingwave/pull/21347)
...
- `3de27c5f972866f559a7e141e01dd3d72c81dada` [feat(e2e, udf): add complex udf tests (#21246)](https://github.com/risingwavelabs/risingwave/pull/21246)
...
## nightly-20250329
[compare changes with previous nightly build](https://github.com/risingwavelabs/risingwave/compare/602d2f7f521198611ce694b264113384a16c18a0...db881a877e4a0d9bb886695d8f78b715d016a1c6)
...
## nightly-20250322
[compare changes with previous nightly build](https://github.com/risingwavelabs/risingwave/compare/c727880e314baf068e2285d3e4530516d89945aa...1370774f1287db0d3da6efe9587a4e2e7805358d)
...
- `9404e93cd1e1340c078b601b441b721f75f5f6b3` [chore(deps): update groups rand, strum and opentelemetry (#21043)](https://github.com/risingwavelabs/risingwave/pull/21043)
...
## nightly-20250301
[compare changes with previous nightly build](https://github.com/risingwavelabs/risingwave/compare/86ce96e7439080af6e5b5081490bb61a1d1a4c7c...cda5da48aaa7db0dcaf751fda311d0b8b86f45ce)
- `cda5da48aaa7db0dcaf751fda311d0b8b86f45ce` [feat: remove support for default column from CDC (#20671)](https://github.com/risingwavelabs/risingwave/pull/20671)
...
- `85fb0deddb8529de24c59ccbcb1819d7bf9e302f` [test(backfill): add scale in test for arrangement backfill in background ddl (#20613)](https://github.com/risingwavelabs/risingwave/pull/20613)
...
- `af3e042171f270c9f29567b0e36b8fc3d86164ce` [doc: Update README.md (#20586)](https://github.com/risingwavelabs/risingwave/pull/20586)
- `15d8ef6f8e520a829d350b75a7c4584b31a8b963` [refactor(iceberg): move scan from batch to connector (#20567)](https://github.com/risingwavelabs/risingwave/pull/20567)
- `e1e6f6dc00f4bd705c27b09b12bee81ae309521e` [refactor: remove unnessary check_iceberg_source (#20566)](https://github.com/risingwavelabs/risingwave/pull/20566)
...
- `1a047ba406fcc61a045b8f438d7d3eb89a1abd07` [feat(frontend): redirect cast char to varchar (#20532)](https://github.com/risingwavelabs/risingwave/pull/20532)
